...
#[cfg_attr(any(target_arch = "loongarch32", target_arch = "loongarch64"), path = "loongarch.rs")]
...
impl OperationNumber {
    ...
    // /// [SYS_TMPNAM (0x0D)](https://github.com/ARM-software/abi-aa/blob/2025Q4/semihosting/semihosting.rst#sys-tmpnam-0x0d)
    ...
    /// [SYS_GET_CMDLINE (0x15)](https://github.com/ARM-software/abi-aa/blob/2025Q4/semihosting/semihosting.rst#sys-get_cmdline-0x15)
    ...
    /// [SYS_EXIT_EXTENDED (0x20)](https://github.com/ARM-software/abi-aa/blob/2025Q4/semihosting/semihosting.rst#sys-exit_extended-0x20)
