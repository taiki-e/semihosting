...
fn main() {
    ...
    if version.minor >= 80 {
        ...
        println!(
            "cargo:rustc-check-cfg=cfg(semihosting_no_duration_checked_float,semihosting_no_error_in_core,semihosting_no_strict_provenance,semihosting_target_feature)"
        );
...
mod version {
    ...
    impl Version {
        ...
        pub(crate) const LATEST: Self = Self::stable(93);
